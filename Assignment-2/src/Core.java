        ...
        if (userType == 1) {
            ...
            if (admin.login(username,password)) {
                ...
                if (adminChoice == 1){
                    ...
                    admin.setSpecialDeals();      //MISSING
                }else if (adminChoice == 6) {
                    admin.viewVisitorStats();      //MISSING
                }else if (adminChoice == 7) {
                    admin.displayFeedback();          // MISSING
            ...
            if (visitorChoice == 1) {
                ...
                if (visitor.login(email, password)) {
                    ...
                    scanner.nextLine();
                    if (visitorChoice2 == 1){
                        visitor.exploreZoo();           //INCOMPLETE ADD SELCTING ANIMALS ATTRACTIONS FURTHER
